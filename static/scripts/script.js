...
xhr.onload = function () {
  ...
  function indexPage() {
    ...
    for (let i = rand; i < rand + 10; i++) {
      output +=
        ...
        '<a class="nav-link text-dark" aria-current="page" href="/movies/' +
        i +
        '"><img src="' +
        data[i].poster +
        '" class="rounded" width="300" height="400">' +
        "<div>" +
        data[i].title +
        "</div></a>" +
        "</div>";
  ...
  function individualMoviePage() {
    ...
    output +=
      '<div class="col-6 random_movies"><a class="nav-link text-dark" aria-current="page" href="#"><img src="' +
      data[i].poster +
      '" class="rounded" width="300" height="400"></a></div>' +
